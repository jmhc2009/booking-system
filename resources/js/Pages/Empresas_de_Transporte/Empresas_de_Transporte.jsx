...
export default function Empresas_de_Transporte({ auth, transportCompanies }) {
    ...
    const openModal = (
        ...
        if (op === 1) {
            setTitle("Crear Empresa de Transporte");
        } else {
            setTitle("Modificar Empresa de Transporte");
            setData({
                id: id,
    ...
    const submit = (e) => {
        ...
        if (operation === 1) {
            ...
            put(route("transportCompanies.update", data.id), {
                onSuccess: () => {
        ...
        alerta
            ...
            .then((result) => {
                if (result.isConfirmed) {
                    destroy(route("transportCompanies.destroy", id), {
                        onSuccess: () => {
                                                            ...
                                                            (transportCompany, i) => (
                                                                ...
                                                                >
                                                                    ...
                                                                    <td className="whitespace-nowrap  px-6 py-4">
                                                                        {
                                                                            transportCompany.business_name
                                                                        }
                                                                    </td>
                                                                        ...
                                                                        <WarningButton
                                                                            onClick={() =>
                                                                                openModal(
                                                                                    ...
                                                                                    transportCompany.id,
                                                                                    transportCompany.business_name,
                                                                                    transportCompany.rut,
                                                                                    transportCompany.turn,
                                                                                    transportCompany.address,
                                                                                    transportCompany.phone,
                                                                                    transportCompany.email
                                                                                )
