...
const Sidebar = () => {   
    ...
    return (
        <main className="flex flex-col justify-between gap-8 bg-gray-100 min-h-screen max-h-screen w-60 p-4 overflow-y-scroll">
            <section>
                <div className="logo flex items-center gap-4 mb-8">
                    ...
                    />
                    <div>
                        <h3 className="font-bold text-indigo-600">SOCOPROSE</h3>
                ...
                <div className="flex items-center gap-4 pt-4 border-t">
                    <div>
                        <h3 className="font-bold text-gray-900">
                            Juan Marco Huenulaf Cumillanca
                        </h3>
                        <p className="text-gray-800 text-xs">
